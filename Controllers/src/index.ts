...
const productRecommendedProductsController = new ProductRecommendedProductsController();

export { restrauntsController, subcategoryController,
     categoryController, productController ,productCategoryController,
     addonController, productSubcategoryController,
     productAddonController, productRecommendedProductsController 
    };
